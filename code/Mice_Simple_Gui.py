...
class Application(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cal = tkc.Calendar(self.mainFrame1, selectmode="day", year=2021, month=5, day=1)
    ...
    def configure_basic_tk_properties(self):
        ...
        self.label3 = ttk.Label(self.mainFrame1, text="Input: ", background ="white")
        self.label4 = ttk.Label(self.mainFrame1, text="Output:", background ="white")
        self.label5= ttk.Label(self.mainFrame1, text="Select Date Interval: ", background ="white")
        self.label6= ttk.Label(self.mainFrame1, text="From:", background ="white")
        self.label7= ttk.Label(self.mainFrame1, text="To:", background ="white")
        ...
        self.button5 = ttk.Button(self, text="Start date", command=self.grab_start_date)
        self.button4 = ttk.Button(self, text="End date", command=self.grab_end_date)
        self.button_quit = ttk.Button(master=self, text="Quit", command=self.quit)
    ...
    def display_plot(self):
        ...
        fig, ay = self.import_excel_file()
        # fig2, ax = MyPlot.my_fxn2()

        self.canvas1 = FigureCanvasTkAgg(fig, master=self.canvas1)
        ...
        self.toolbar.pack(side=tk.BOTTOM, fill=tk.X, padx=400)
    ...
    def import_excel_file(self):
        ...
        axs[0,0].hist(d2[0], bins=b+1, color=colors[0], label='Male Wildtype', edgecolor='black')
        axs[0,1].hist(d2[1], bins=b+1, color=colors[1], label='Female Wildtype', edgecolor='black')
        axs[1,0].hist(d2[2], bins=b+1, color=colors[2], label='Male Heterozygous', edgecolor='black')
        axs[1,1].hist(d2[3], bins=b+1, color=colors[3], label='Female Heterozygous', edgecolor='black')
